function mostrarCuadrilla(cuadrilla, usuarioActivo) {
  ...
  if (cuadrilla) {
    ...
    if (cuadrilla.integrantes && cuadrilla.integrantes.length > 0) {
      ...
      html += `<div class="accordion modern-accordion" id="accordionIntegrantes">`;
      ...
      integrantes.forEach((emp, idx) => {
        ...
        const collapseId = `integrante-${idx}`;
              ...
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                ...
                <div class="d-flex align-items-center w-100">
                  ...
                  <div class="ms-auto d-flex align-items-center gap-1">
                    ${esUsuarioActivo ? `<span class="badge bg-primary-subtle text-primary border border-primary-subtle">Tú</span>` : ""}
                    ${esLider ? `<span class="badge bg-warning text-dark">Líder</span>` : ""}
                  </div>
                </div>
              </button>
            </h2>
            <div id="${collapseId}" class="accordion-collapse collapse" data-bs-parent="#accordionIntegrantes">
